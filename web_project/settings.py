...
SECRET_KEY = 'django-insecure-y_(2=h1h*a17)g(uphj40y$tb)fqmw#_=o%#a=kmifkp6i$i)$'
...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend',  # Mantenha como fallback
]
...
MIDDLEWARE = [
    ...
    'authentication.middleware.AccessControlMiddleware',
...
LOGIN_SECURITY_CONFIG = {
    ...
    'IP_LOCKOUT_ATTEMPTS': 8,  # Tentativas por IP
    'IP_LOCKOUT_TIME': 1800,  # 30 minutos para IP
}

# Configurações de cache para bloqueio (usando database cache como fallback)
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.db.DatabaseCache',
        'LOCATION': 'login_security_cache',
    }
}
...
# CORS (útil para desenvolvimento)
